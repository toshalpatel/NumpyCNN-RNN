...
Fashion_mnist.x_train = Fashion_mnist.x_train.astype('float32')
Fashion_mnist.x_test = Fashion_mnist.x_test.astype('float32')
Fashion_mnist.x_train /= 255
Fashion_mnist.x_test /= 255
