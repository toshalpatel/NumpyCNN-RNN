...
def MySentiment_RNN(word_to_idx):
    ...
    model.add(Linear2D(100, 128, name='linear1', initializer=Gaussian(std=0.01)))
    model.add(TemporalPooling()) # defined in layers.py
    model.add(Linear2D(128, 2, name='linear2', initializer=Gaussian(std=0.01)))
